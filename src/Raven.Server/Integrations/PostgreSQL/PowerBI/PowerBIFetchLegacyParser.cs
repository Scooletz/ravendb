...
{
    internal static class PowerBIFetchLegacyParser
    {
        /// <summary>
        ...
        internal static bool TryParseLegacy(string queryText, int[] parametersDataTypes, DocumentDatabase documentDatabase, out PgQuery pgQuery)
        {
